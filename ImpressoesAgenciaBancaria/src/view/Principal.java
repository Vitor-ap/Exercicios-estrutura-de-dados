...
public class Principal {
	...
	public static void main(String[] args) {
		...
		do {
			opcao = JOptionPane.showOptionDialog(null, "Selecione o que deseja fazer. Obs: Identificação e NomeArquivo separados por   ' ; '    Exemplo: PcdoChefe ; Relatorio  ", "Confirmation",
